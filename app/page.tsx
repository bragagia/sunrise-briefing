...
export default function Home() {
  ...
  const creationDate = 'Friday, August 18, 2023';
  ...
  return (
    <div>
      {lastBriefing == null ? (
        ...
        <>
          <p className="mb-16 font-playfair-display text-center">
            {creationDate}
          </p>
          <SubscriptionField />
          <div className="text-justify text-gray-900 whitespace-pre-line font-hanken-grotesk my-10">
            {briefingContent}
          </div>
        </>
      )}
